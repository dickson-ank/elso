    ...
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div
        className={`rounded-lg px-4 py-3 max-w-2xl ${
          isUser
            ? "bg-muted dark:bg-muted/30 text-foreground dark:text-foreground text-sm md:text-base font-medium"
            : "max-w-full dark:text-card-foreground text-sm md:text-base font-medium dark:font-medium"
        }`}
      >
